...
const ColdRoomEquippments = () => {
  return (
    <section>
      <div class="products-categories">
        <div class="products-categories-layout">
          <img
            src="../images/coldroomproducts.jpg"
            alt="products-categories-layout"
            class="products-categories-layout-image"
            loading="lazy"
          />
          <div class="products-categories-layout-text">Cold RoomEquipments</div>
        </div>
        ...
        <div class="products-categories-content">
          ...
          <div class="products-categories-p">
            ...
            and energy efficiency in construction projects. Whether its roofing,
            walling, or flooring, these panels provide a seamless barrier
            against heat transfer, moisture infiltration, and sound
...
export default ColdRoomEquippments;
